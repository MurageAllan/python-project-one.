...
Lb1_dosa = Label(f1,font=("arial", 20, 'bold'), text="Dosa", width=12, fg="blue4")
Lb1_cookies = Label(f1,font=("arial", 20, 'bold'), text="Cookies", width=12, fg="blue4")
Lb1_Tea = Label(f1,font=("arial", 20, 'bold'), text="Tea", width=12, fg="blue4")
Lb1_Coffee = Label(f1,font=("arial", 20, 'bold'), text="Coffee", width=12, fg="blue4")
Lb1_Juice = Label(f1,font=("arial", 20, 'bold'), text="Juice", width=12, fg="blue4")
Lb1_Pancakes = Label(f1,font=("arial", 20, 'bold'), text="Pancakes", width=12, fg="blue4")
Lb1_Eggs = Label(f1,font=("arial", 20, 'bold'), text="Eggs", width=12, fg="blue4")
